...
class ModalCreateNewAccount extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <ModalFooter>
                    <Button color="primary" className='px-3' onClick={() => {this.handleAddNewAccount()}}>Create</Button>{' '}
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalCreateNewAccount);
